...
const entity_1 = require("@dcl/ecs/dist-cjs/engine/entity");
const asset_packs_1 = require("@dcl/inspector/node_modules/@dcl/asset-packs");
...
function createActionCallback(actionRef) {
    return () => {
        ...
        const actionEvents = (0, asset_packs_1.getActionEvents)(actionRef.entity);
