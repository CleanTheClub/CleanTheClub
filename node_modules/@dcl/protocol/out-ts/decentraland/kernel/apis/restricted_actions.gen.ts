...
import { AvatarMask, avatarMaskFromJSON, avatarMaskToJSON } from "../../sdk/components/common/avatar_mask.gen";
...
export namespace TriggerEmoteRequest {
  ...
  export function fromJSON(object: any): TriggerEmoteRequest {
    return {
      ...
      mask: isSet(object.mask) ? avatarMaskFromJSON(object.mask) : undefined,
    };
  }
  ...
  export function toJSON(message: TriggerEmoteRequest): unknown {
    ...
    message.mask !== undefined && (obj.mask = message.mask !== undefined ? avatarMaskToJSON(message.mask) : undefined);
    return obj;
  }
